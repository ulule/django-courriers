...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsletterSubscriber.unsubscribed_at'
        db.add_column(u'courriers_newslettersubscriber', 'unsubscribed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsletterSubscriber.unsubscribed_at'
        db.delete_column(u'courriers_newslettersubscriber', 'unsubscribed_at')
